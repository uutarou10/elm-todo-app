...
var author$project$Main$Mid = {$: 'Mid'};
var author$project$Main$Todo = F4(
	function (id, title, isCompleted, importance) {
		return {id: id, importance: importance, isCompleted: isCompleted, title: title};
	});
...
var author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{
			draftImportance: author$project$Main$Mid,
			draftTitle: '',
			filter: author$project$Main$All,
			todos: _List_fromArray(
				[
					A4(author$project$Main$Todo, 'test', '牛乳を買う', false, author$project$Main$High)
				])
		},
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var value = msg.a;
				var newImportance = function () {
					switch (value) {
						case 'High':
							return author$project$Main$High;
						case 'Mid':
							return author$project$Main$Mid;
						case 'Low':
							return author$project$Main$Low;
						default:
							return author$project$Main$Mid;
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{draftImportance: newImportance}),
					elm$core$Platform$Cmd$none);
		}
	});
var author$project$Main$UpdateImportance = function (a) {
	return {$: 'UpdateImportance', a: a};
};
				...
				[
					...
					_List_fromArray(
						[
							...
							elm$html$Html$Attributes$checked(todo.isCompleted)
						]),
					_List_Nil),
					A2(
					elm$html$Html$p,
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onInput(author$project$Main$UpdateImportance)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										_Utils_eq(model.draftImportance, author$project$Main$High))
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$value('Mid'),
										elm$html$Html$Attributes$selected(
										_Utils_eq(model.draftImportance, author$project$Main$Mid))
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Attributes$selected(
										_Utils_eq(model.draftImportance, author$project$Main$Low))
									]),
								_List_fromArray(
									[
	...
	return {
		body: _List_fromArray(
			[
				...
				elm$html$Html$ul,
				_List_Nil,
				A2(elm$core$List$map, todoItem, model.todos))
			]),
		title: 'Elm Todo'
	};
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"UpdateTitle":["String.String"],"UpdateImportance":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
...
},{"./Main.elm":"src/Main.elm"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
